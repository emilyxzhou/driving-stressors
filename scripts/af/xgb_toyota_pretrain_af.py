...
subjects, X_test, y_test = load_dataset(normalized=True, scaled=True, binarize_threshold="median", apply_normalization=False, resample=False)
...
folder = f"results_xgb_toyota_pretrain_af"
...
# fig_path = "/home/emilyzho/distracted-driving/figs/toyota_pretrain_shap.png"
